...
namespace iText.Pdfocr.Onnx.Orientation {
    ...
    public class OnnxOrientationPredictor : AbstractOnnxPredictor<IronSoftware.Drawing.AnyBitmap, TextOrientation
        ...
        public static iText.Pdfocr.Onnx.Orientation.OnnxOrientationPredictor MobileNetV3(String modelPath) {
            return new iText.Pdfocr.Onnx.Orientation.OnnxOrientationPredictor(OnnxOrientationPredictorProperties.MobileNetV3
                (modelPath));
        }
        ...
        /// <returns>a new predictor with the MobileNetV3 model loaded</returns>
        public static iText.Pdfocr.Onnx.Orientation.OnnxOrientationPredictor MobileNetV3(String modelPath, IOrtSessionOptionsCreator
