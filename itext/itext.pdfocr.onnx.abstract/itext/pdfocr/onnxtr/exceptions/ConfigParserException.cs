...
namespace iText.Pdfocr.Onnxtr.Exceptions {
    ...
    public class ConfigParserException : PdfOcrException {
        ...
        public static iText.Pdfocr.Onnxtr.Exceptions.ConfigParserException UnexpectedValueForKey(String key) {
            return new iText.Pdfocr.Onnxtr.Exceptions.ConfigParserException(MessageFormatUtil.Format(PdfOcrOnnxTrExceptionMessageConstant
        ...
        /// <returns>the created exception</returns>
        public static iText.Pdfocr.Onnxtr.Exceptions.ConfigParserException UnexpectedKey(String key) {
            return new iText.Pdfocr.Onnxtr.Exceptions.ConfigParserException(MessageFormatUtil.Format(PdfOcrOnnxTrExceptionMessageConstant
