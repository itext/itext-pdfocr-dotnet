...
namespace iText.Pdfocr.Onnx.Text {
    ...
    public class TextPositioningModePaddleOcrTest : ExtendedITextTest {
        ...
        private static readonly String TARGET_DIRECTORY = NUnit.Framework.TestContext.CurrentContext.TestDirectory
             + "/test/resources/itext/pdfocr/text/TextPositioningModePaddleOcrTest/";

        public static IEnumerable<Object[]> Parameters() {
            return JavaUtil.ArraysAsList(new Object[] { OcrEngineTypeWithTextPositioning.PADDLE_LINES }, new Object[] 
                { OcrEngineTypeWithTextPositioning.PADDLE_WORDS }, new Object[] { OcrEngineTypeWithTextPositioning.PADDLE_WORDS_AND_LINES
                 });
        }
        ...
        public static void AfterClass() {
            OcrEngineTypeWithTextPositioning.PADDLE_LINES.instance.Close();
            OcrEngineTypeWithTextPositioning.PADDLE_WORDS.instance.Close();
            OcrEngineTypeWithTextPositioning.PADDLE_WORDS_AND_LINES.instance.Close();
        }
