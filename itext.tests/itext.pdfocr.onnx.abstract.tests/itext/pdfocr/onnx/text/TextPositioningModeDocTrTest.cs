...
namespace iText.Pdfocr.Onnx.Text {
    ...
    public class TextPositioningModeDocTrTest : ExtendedITextTest {
        ...
        private static readonly String TARGET_DIRECTORY = NUnit.Framework.TestContext.CurrentContext.TestDirectory
             + "/test/resources/itext/pdfocr/text/TextPositioningModeDocTrTest/";

        public static IEnumerable<Object[]> Parameters() {
            return JavaUtil.ArraysAsList(new Object[] { OcrEngineTypeWithTextPositioning.DOCTR_LINES }, new Object[] { 
                OcrEngineTypeWithTextPositioning.DOCTR_WORDS }, new Object[] { OcrEngineTypeWithTextPositioning.DOCTR_WORDS_AND_LINES
                 });
        }
