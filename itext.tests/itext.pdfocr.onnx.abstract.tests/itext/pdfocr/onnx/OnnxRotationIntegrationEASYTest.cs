...
namespace iText.Pdfocr.Onnx {
    ...
    public class OnnxRotationIntegrationEASYTest : ExtendedITextTest {
        ...
        private static readonly String TARGET_DIRECTORY = NUnit.Framework.TestContext.CurrentContext.TestDirectory
             + "/test/resources/itext/pdfocr/OnnxRotationIntegrationEASYTest/";

        private static readonly IOcrEngine OCR_ENGINE = OcrEngineTypeWithOrientation.EASY.Get();
