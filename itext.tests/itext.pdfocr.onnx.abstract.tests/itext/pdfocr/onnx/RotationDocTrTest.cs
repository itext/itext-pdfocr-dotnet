...
namespace iText.Pdfocr.Onnx {
    ...
    public class RotationDocTrTest : ExtendedITextTest {
        ...
        private static readonly String TARGET_DIRECTORY = NUnit.Framework.TestContext.CurrentContext.TestDirectory
             + "/test/resources/itext/pdfocr/RotationDocTrTest/";

        private static readonly IOcrEngine OCR_ENGINE = OcrEngineTypeWithOrientation.DOCTR.Get();

        private const String OCR_NAME = "DocTR";
