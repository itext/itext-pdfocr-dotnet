...
namespace iText.Pdfocr.Onnx.Util {
    public sealed class OcrEngineType {
        public static readonly iText.Pdfocr.Onnx.Util.OcrEngineType PADDLE = new iText.Pdfocr.Onnx.Util.OcrEngineType
            ("PaddleOCR", () => CreatePaddleOcrEngine());

        public static readonly iText.Pdfocr.Onnx.Util.OcrEngineType EASY = new iText.Pdfocr.Onnx.Util.OcrEngineType
...
//\endcond
        ...
        public static iText.Pdfocr.Onnx.Util.OcrEngineType[] All() {
            return new iText.Pdfocr.Onnx.Util.OcrEngineType[] { iText.Pdfocr.Onnx.Util.OcrEngineType.PADDLE, iText.Pdfocr.Onnx.Util.OcrEngineType
