...
namespace iText.Pdfocr.Onnx {
    ...
    public class RotationPaddleOcrTest : ExtendedITextTest {
        ...
        private static readonly String TARGET_DIRECTORY = NUnit.Framework.TestContext.CurrentContext.TestDirectory
             + "/test/resources/itext/pdfocr/RotationPaddleOcrTest/";

        private static readonly OnnxOcrEngine OCR_ENGINE = OcrEngineTypeWithOrientation.PADDLE.Get();
