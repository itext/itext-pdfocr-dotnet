...
namespace iText.Pdfocr.Onnx {
    ...
    public class RotationEasyOcrTest : ExtendedITextTest {
        ...
        private static readonly String TARGET_DIRECTORY = NUnit.Framework.TestContext.CurrentContext.TestDirectory
             + "/test/resources/itext/pdfocr/RotationEasyOcrTest/";

        private static readonly OnnxOcrEngine OCR_ENGINE = OcrEngineTypeWithOrientation.EASY.Get();

        private const String OCR_NAME = "EasyOCR";
        ...
        [NUnit.Framework.Test]
        public virtual void RotatedLinesTest() {
